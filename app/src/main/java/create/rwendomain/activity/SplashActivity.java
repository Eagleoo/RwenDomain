...
import create.rwendomain.util.BitmapUtil;
import create.rwendomain.util.cache.ACache;
import create.rwendomain.util.constant.Constant;
...
public class SplashActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        splashBitmap = BitmapUtil.resizeBitmap(screenWidth, screenHeight - getStatusBarHeight(),
                BitmapFactory.decodeResource(getResources(), R.drawable.luanch_img));
