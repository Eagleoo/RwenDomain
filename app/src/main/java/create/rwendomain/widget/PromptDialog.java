...
import create.rwendomain.util.AnimationLoader;
import create.rwendomain.util.DisplayUtil;
...
public class PromptDialog extends Dialog implements View.OnClickListener {
    ...
    private TextView mTitleTv, mContentTv, mPositiveBtn,btnNegative;
    ...
    private void initView() {
        ...
        btnNegative= (TextView) contentView.findViewById(R.id.btnNegative);
        ...
        mContentTv.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG); //下划线
        mContentTv.getPaint().setAntiAlias(true);//抗锯齿
    ...
    public void onClick(View v) {
        ...
        if (R.id.btnPositive == id) {
            mOnPositiveListener.onClick(this);
        } else if (R.id.btnNegative == id) {
            mOnNegativeListener.onClick(this);
        } else {
        }
    }
